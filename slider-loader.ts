...
(async () => {
    ...
    createControlsPanel(example, 'slider');
})();
...
function createControlsPanel(example: Record<string, unknown>, theme: 'switch' | 'slider') {
    ...
    styleSheet.textContent = `
        ...
        .controls-panel {
            ...
            right: 1.25rem;
            z-index: 100;
            background: linear-gradient(135deg, rgba(25, 15, 20, 0.95) 0%, rgba(40, 25, 35, 0.9) 100%);
            ...
            box-shadow:
                ...
                0 0 80px rgba(240, 147, 251, 0.15);
        ...
        .custom-slider {
            ...
            height: 6px;
            border-radius: 3px;
            background: linear-gradient(90deg, rgba(240, 147, 251, 0.3) 0%, rgba(245, 87, 108, 0.3) 100%);
            outline: none;
            transition: all 0.2s ease;
        }
        .custom-slider:hover {
            background: linear-gradient(90deg, rgba(240, 147, 251, 0.5) 0%, rgba(245, 87, 108, 0.5) 100%);
        }
        ...
        .custom-toggle.active::after {
            ...
            box-shadow: 0 2px 12px rgba(240, 147, 251, 0.5);
        }
        .toggle-hidden {
            position: absolute;
            opacity: 0;
    ...
    header.innerHTML = `
        ...
        <div class="controls-subtitle">Jelly Slider</div>
    `;
